...
#import "Horizontal2ViewController.h"

@interface Horizontal2ViewController ()

@end

@implementation Horizontal2ViewController
...
- (IBAction)calcular:(id)sender {
    ...
    // A
    double xPuntoA = x + tres;
    double yPuntoA = y - dos;
    
    // B
    double xPuntoB = x - cuatro;
    double yPuntoB = y;
